...
int main()
{
	...
	// In case the CRL is massive, its serial numbers can be put in a hashmap for O(1) lookup.
	...
	*/
	...
	// Now we have 2 vectors: chainFileSerialNumbers and revokedSerialNumbers, with the required serial numbers.
